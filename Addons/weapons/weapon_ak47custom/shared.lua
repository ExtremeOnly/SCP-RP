...
if CLIENT then
    SWEP.PrintName = "AK47 (Admin weapon)" -- The name that shows in the scroll menu and when you hover over the gun in the q-menu.
    SWEP.Author = "DarkRP Developers and Max White" -- Author Name.
...
SWEP.Primary.Recoil = 0.1 -- How much the gun will jump while shooting.
SWEP.Primary.Damage = 9999 -- How much it will hurt every time a bullet hits its target.
...
SWEP.Primary.ClipSize = 100 -- How much ammo can you hold in the clip at one time.
SWEP.Primary.Delay = 0.08 -- A delay between shots. Effects fire speed.
SWEP.Primary.DefaultClip = 90 -- How much ammo you spawn with.
