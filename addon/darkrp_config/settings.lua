...
GM.Config.F1MenuHelpPage = "https://ExtremeOnly.net.pl/www"
GM.Config.F1MenuHelpPageTitle = "Nasza strona"

-- Put Steam ID's and ranks in this list, and the players will have that rank when they join.
GM.Config.DefaultPlayerGroups = {
    ["STEAM_0:0:63440416"] = "superadmin",
...
GM.Config.DisallowDrop = {
	...
	["weapon_scp066"] = true,
	["weapon_scp096swep"] = true,
	["scp_1048"] = true,
	["weapon_scp173swep"] = true,
	["eoti_werewolf_swep"] = true,
	["weapon_scp457"] = true,
	["weapon_scp8602"] = true,
	["weapon_scp939swep"] = true,
	["weapon_scp1048a"] = true,
	["weapon_966"] = true,
...
GM.Config.DefaultLaws = {
    "1. Nie afcz podczas akcji RP.",
    "2. Nie rób RDM MRDM.",
    "3. Stosuj sie do regulaminu.",
}
...
GM.Config.afkdemotetime = 1300
-- Prevent people from spamming AFK.
GM.Config.AFKDelay = 900
