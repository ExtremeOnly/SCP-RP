...
AddAgenda("MFO Hammer Down", TEAM_MFOHDGEN, {TEAM_MFOHDZW, TEAM_MFOR, TEAM_MFOMED, TEAM_MFODOG, TEAM_MFOW, TEAM_MFOWS})
AddAgenda("MFO Alpha 1", TEAM_MFOA1GEN, {TEAM_MFOA1})
